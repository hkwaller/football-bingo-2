    ...
    <div className="w-full flex flex-col gap-3 mb-6">
      <div className="flex items-end justify-between gap-4">
        ...
        <div>
          ...
          <h1 className="mt-2.5 font-display text-[40px] font-black uppercase leading-[0.9] text-on-green md:text-[52px]">
            Quick fire ⚡
          </h1>
        </div>
        ...
        <div className="flex shrink-0 gap-2">
          <span className="inline-flex items-center rounded-lg bg-black/25 px-4 py-2 font-mono text-sm font-bold tabular-nums text-yellow">
            {score.toLocaleString()} pts
          </span>
          {streak >= 2 && (
            <span className="inline-flex items-center rounded-lg bg-black/25 px-4 py-2 text-[13px] font-extrabold text-pink">
              🔥 ×{streak}
            </span>
          )}
        </div>
