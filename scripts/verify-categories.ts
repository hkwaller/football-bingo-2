...
checkKind('managers', managers, (l) => arrayMatchCount(l, (p) => (p as { managers?: string[] }).managers))
...
if (unresolved.size) {
  ...
  console.warn('  (Untracked clubs are expected; scan for variants of tracked clubs needing an alias.)')
