...
const countryFlags: Record<string, string> = {
  Algeria: 'dz', Angola: 'ao', Argentina: 'ar', Armenia: 'am', Aruba: 'aw',
  Australia: 'au', Austria: 'at', Barbados: 'bb', Belgium: 'be', Benin: 'bj',
  'Bosnia-Herzegovina': 'ba', Brazil: 'br', Bulgaria: 'bg', Burundi: 'bi',
  Cameroon: 'cm', Canada: 'ca', 'Cape Verde': 'cv', Chile: 'cl',
  Colombia: 'co', Congo: 'cg', "Cote d'Ivoire": 'ci', Croatia: 'hr',
  'Czech Republic': 'cz', 'DR Congo': 'cd', Denmark: 'dk', Ecuador: 'ec',
  Egypt: 'eg', England: 'gb-eng', Eritrea: 'er', Finland: 'fi', France: 'fr',
  'French Guiana': 'gf', Gabon: 'ga', Germany: 'de', Ghana: 'gh',
  Guadeloupe: 'gp', Guinea: 'gn', 'Guinea-Bissau': 'gw', Hungary: 'hu',
  Iran: 'ir', Ireland: 'ie', Italy: 'it', Jamaica: 'jm', Japan: 'jp',
  'Korea, South': 'kr', Kosovo: 'xk', Liberia: 'lr', Mali: 'ml',
  Martinique: 'mq', Mexico: 'mx', Montenegro: 'me', Morocco: 'ma',
  Netherlands: 'nl', Nigeria: 'ng', 'North Macedonia': 'mk', Norway: 'no',
  Poland: 'pl', Portugal: 'pt', Romania: 'ro', Russia: 'ru',
  'Sao Tome and Principe': 'st', Scotland: 'gb-sct', Senegal: 'sn',
  Serbia: 'rs', 'Sierra Leone': 'sl', Slovakia: 'sk', Slovenia: 'si',
  Spain: 'es', 'St. Kitts & Nevis': 'kn', 'St. Lucia': 'lc', Suriname: 'sr',
